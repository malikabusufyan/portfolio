    ...
    <section id="experience" className="py-20">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="space-y-8">
          {items.map((item, i) => (
            <Reveal key={item._id} delay={Math.min(i, 4) * 0.08}>
              <article className="group flex gap-5 rounded-2xl border border-gray-200 bg-white/90 p-6 shadow-sm backdrop-blur-sm transition hover:-translate-y-1 hover:shadow-lg dark:border-gray-800 dark:bg-gray-900/90">
